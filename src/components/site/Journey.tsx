    ...
    <section className="relative overflow-hidden py-28 sm:py-32 gradient-hero-bg">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded-full bg-white/80 backdrop-blur px-3 py-1 text-xs font-semibold uppercase tracking-widest text-forest-deep">
            The patient journey
          </div>
        ...
        <div className="relative mt-20">
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute left-0 right-0 top-11 hidden lg:block h-px bg-gradient-to-r from-transparent via-forest/40 to-transparent"
          />
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6">
            {STEPS.map((s, i) => (
              ...
              >
                <div className="relative mx-auto grid size-[88px] place-items-center rounded-2xl glass shadow-card transition-transform duration-500 group-hover:-translate-y-1">
                  <div className="grid size-14 place-items-center rounded-xl bg-[image:var(--gradient-green)] text-white shadow-glow-green">
                    <s.icon className="size-6" />
                  </div>
                  <div className="absolute -top-3 -left-3 grid size-7 place-items-center rounded-full bg-navy text-[11px] font-semibold text-white">
                    {i + 1}
                  </div>
                </div>
                <div className="mt-6 text-center">
                  <div className="font-display text-xl text-navy">{s.title}</div>
